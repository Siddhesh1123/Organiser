...
class Window:
    def _init_(self, width, height, x, y, title, resizable=(False, False), icon=None):
        self.white = '#fff'
        self.bt_bg = '#D49137'
        self.input_bg = '#F5C26B'
        self.sel_bg = '#CBCACC'
    ...
    def draw_widget(self):
        ...
        # ======== Label ==========
        l_title = Label(self.root, text='Organiser', font='ComicSansMs 18', bg=self.white)
...
if __name__ == '__main__':
    window = Window(600, 410, 390, 160, 'Organiser')
    window.draw_widget()
    window.run()